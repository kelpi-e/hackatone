...
class Resume:
    def __init__(
        ...
        self.practice_report = practice_report
    ...
    def summary(self):
        ...
        # Если передан готовый текст практического отчета, используем его.
        # Иначе суммаризируем push_practical записи через LLM как раньше.
        if self.practice_report:
            practical_summary = self.practice_report
        else:
